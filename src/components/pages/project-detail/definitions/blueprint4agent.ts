...
export function getBlueprint4AgentDetailCanvas(
  ...
  const nodes: CanvasNode[] = [
    ...
    },
    {
      ...
      width: 52,
      markdown:
        "# Blueprint4Agent\n\n**Blueprint4Agent는 에이전틱 코딩 기반으로 AI 애플리케이션을 빠르게 시작하고 운영하기 위한 프로젝트 블루프린트입니다.**\n\nFastAPI 기반 풀스택 서버 템플릿인 **B4FastAPI**를 중심으로 인증, 배포, 문서화, 테스트, CI/CD, 모니터링까지 프로젝트에 필요한 기반 환경을 하나의 표준 구조로 제공합니다.\n\n반복적으로 필요한 초기 설정을 미리 갖춘 상태에서 **AI Agent와 개발자가 프로젝트 구성보다 기능 구현에 집중할 수 있는 개발 환경**을 목표로 설계했습니다.",
    },
    {
      id: "info",
      title: "Info",
